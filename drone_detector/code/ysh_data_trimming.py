...
for DURATION in drlist:
    ...
    for path in name:
        ...
        Trim_dataDir = '{}{}{}{}'.format('/home/stealthdrone/Desktop/dataset/',DURATION,'Trimmed_audio_',path)
        Trim_csvPath = '{}{}{}{}{}'.format('/home/stealthdrone/Desktop/csv/',DURATION,'Trimmed_audio_',path,'.csv')
