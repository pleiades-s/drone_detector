...
def save_newfile(y, name, label, fold):
...
for path in name:
    ...
    Trim_dataDir = '/home/stealthdrone/Desktop/dataset/0.1Trimmed_audio_'+path
    Trim_csvPath = '/home/stealthdrone/Desktop/csv/0.1Trimmed_audio_'+path+'.csv'
    ...
    for i in os.listdir(dataDir):
        try:
            ...
            save_newfile(y, name, sound_type, fold)
